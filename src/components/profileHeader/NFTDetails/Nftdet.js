        ...
        {!bid && (
          <div>
            <div className="flex space-x-4 my-5">
              <Owner
                img={props.allUserProfile[props.currentOwner].imageHash}
                deg="Owner"
                name={props.allUserProfile[props.currentOwner].name}
              ></Owner>
              <Owner
                img={props.allUserProfile[props.mintedBy].imageHash}
                deg="Creator"
                name={props.allUserProfile[props.mintedBy].name}
              ></Owner>
            </div>
            {
              <div>
            ...
            }
            {
              <div>
                ...
                {currentTab.owner && (
                  <OwnerList owners={props.owner}></OwnerList>
                )}
