...
(function() {
    ...
    3: [function(j, q, z) {
        ...
        q.exports = function(t) {
            function e(t) {
                ...
                return x.x = 1 - 2 * (t.x - e.left) / e.width, x.y = 1 - 2 * (t.y - e.top) / e.height
            }

            function n(t, e) {
                return   this.svg = t, this.indices = e, this.zIndex = 0
            }
            ...
            function r(t) {
                for (var e = t[0], n = t[1], r = t[2], i = t[3], o = t[4], a = t[5], l = t[6], u = t[7], s = t[8], f = t[9], h = t[10], c = t[11], d = t[12], w = t[13], v = t[14], g = t[15], m = 0; m < F; ++m) {
                    var p = N[3 * m],
                        ...
                        y = N[3 * m + 2],
                        x = p * i + A * u + y * c + g;
                        return    M[3 * m] = (p * e + A * o + y * s + d) / x, M[3 * m + 1] = (p * n + A * a + y * f + w) / x, M[3 * m + 2] = (p * r + A * l + y * h + v) / x
                }
            }
                ...
                for (b.length = 0, t = 0; t < S.length; ++t) {
                    ...
                    if (!((c - f) * (M[3 * s + 1] - h) - (d - h) * (w - f) < 0)) {
                        for (var v = [], g = -1 / 0, m = 1 / 0, p = o.svg, A = 0; A < 3; ++A) {
                            ...
                            var F = M[3 * x + 2];
                            return    g = Math.max(g, F), m = Math.min(m, F)
                        }
                        o.zIndex = g + .25 * m;
                        var N
                        return N = v.join(" "); - 1 === N.indexOf("NaN") && setAttribute(p, "points", N), b.push(o)
                    }
                }
            ...
            function f() {
                if (v) {
                    ...
                    return    g[0] = t * g[0] + m * x.x, g[1] = t * g[1] + m * x.y + .085;
                    return    r(k()), o(), a()
                }
            }
            var h = t || {},
                ...
                b = [];
                return h.pxNotRatio || (p = window.innerWidth * (h.width || .25) | 0, A = 0 | (window.innerHeight * h.height || p), "minWidth" in h && p < h.minWidth && (p = h.minWidth, A = p)), setAttribute(y, "width", p + "px"), setAttribute(y, "height", p + "px"), document.body.appendChild(y),
                function() {
                    ...
                    for (var t = [], e = 0; e < foxJSON.chunks.length; ++e)
                        for (var r = foxJSON.chunks[e], i = "rgb(" + r.color + ")", o = r.faces, a = 0; a < o.length; ++a) {
                            var l = o[a],
                                ...
                                return    setAttribute(u, "fill", i), setAttribute(u, "stroke", i), setAttribute(u, "points", "0,0, 10,0, 0,10"), y.appendChild(u), t.push(new n(u, l))
                        }
                    return t
                }(),
                k = function() {
                    ...
                    return function() {
                        ...
                        if (B(n, Math.PI / 4, d / v, 100, 1e3), invert(a, n), l[0] = g[0], l[1] = g[1], l[2] = 1.2, transform(l, l, a), transform(l, l, o), lookAt(r, t, l, e), w) {
                            var m = Date.now() / 1e3;
                            return    rotate(r, r, .1 + .2 * Math.sin(m / 3), s), rotate(r, r, .03 * Math.sin(m / 2) - .1, h), rotate(r, r, .5 + .2 * Math.sin(m / 3), f)
                        }
    ...
    10: [function(F, G, H) {
        function rotate(t, a, r, e) {
            var o, n, s, h, u, M, l, c, i, b, d, f, m, p, q, v, x, g, j, k, w, y, z, A, B = e[0],
                C = e[1],
                D = e[2],
