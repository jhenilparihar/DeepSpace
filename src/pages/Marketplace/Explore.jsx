...
filter_op.classList.toggle('filter-op1');
  ...
  <div class="container main-container">
     ...
     <div className="status-div">
       ...
       <div className="status-options">
         <div className="flex-div">
           <form action="">
         <div className="part1">
           <input className="stat" typeof="number" placeholder="Min"></input>
           <p>to</p>
           <input className="stat" typeof="number" placeholder="Max"></input>
         </div>
         <div className="part2">
           <button className="stat" typeof="submit">Apply</button>
    ...
    <div class="row" >
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 details-div">
       <div class="inner-div">
